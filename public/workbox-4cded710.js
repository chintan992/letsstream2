define(["exports"], function (t) {
  ...
  class b {
    ...
    async cachePut(t, e) {
      ...
      if (!a) return !1;
      const { cacheName: c, matchOptions: o } = this.u,
  ...
  class D extends v {
    ...
    async _(t, e) {
      ...
      const a = this.N({ timeoutId: r, request: t, logs: n, handler: e });
      i.push(a);
    ...
    async N({ timeoutId: t, request: e, logs: s, handler: n }) {
      let i, r;
      try {
  ...
  function C(t) {
    return t !== IDBDatabase.prototype.transaction ||
      ...
      ? (
        ...
        ? function (...e) {
            return (t.apply(j(this), e), S(N.get(this)));
          }
        : function (...e) {
            return S(t.apply(j(this), e));
          }
      : function (e, ...s) {
          const n = t.call(j(this), e, ...s);
          return (L.set(n, e.sort ? e.sort() : [e]), S(n));
        };
  }
  function P(t) {
  ...
  function S(t) {
    if (t instanceof IDBRequest)
      return (function (t) {
        ...
        return (
          e
            .then(e => {
              e instanceof IDBCursor && N.set(e, t);
            })
            .catch(() => {}),
          B.set(e, t),
          e
    ...
    const e = P(t);
    return (e !== t && (T.set(t, e), B.set(e, t)), e);
  }
  const j = t => B.get(t);
  function M(
    t,
    ...
    return (
      n &&
        a.addEventListener("upgradeneeded", t => {
          n(S(a.result), t.oldVersion, t.newVersion, S(a.transaction), t);
        }),
  ...
  O = (t =>
    x({}, t, {
      get: (e, s, n) => F(e, s) || t.get(e, s, n),
      has: (e, s) => !!F(e, s) || t.has(e, s),
    }))(O);
  try {
  ...
  class H {
    constructor(t) {
      ((this.k = null), (this.L = t));
    }
    T(t) {
      const e = t.createObjectStore($, { keyPath: "id" });
    ...
    async expireEntries(t, e) {
      ...
      const a = [];
      for (const t of i) (await s.delete($, t.id), a.push(t.url));
      return a;
    }
    O(t) {
      return this.L + "|" + G(t);
    ...
    async getDb() {
      return (
        this.k ||
          (this.k = await M("workbox-expiration", 1, {
            upgrade: this.B.bind(this),
          })),
        this.k
      );
    }
  ...
  class Q {
    ...
    async expireEntries() {
      if (this.C) return void (this.P = !0);
      this.C = !0;
      const t = this.j ? Date.now() - 1e3 * this.j : 0,
        e = await this.W.expireEntries(t, this.S),
        s = await self.caches.open(this.L);
      for (const t of e) await s.delete(t, this.M);
      ((this.C = !1), this.P && ((this.P = !1), E(this.expireEntries())));
    }
    ...
    async isURLExpired(t) {
      if (this.j) {
        const e = await this.W.getTimestamp(t),
          s = Date.now() - 1e3 * this.j;
        return void 0 === e || e < s;
      }
      return !1;
    }
    async delete() {
      ((this.P = !1), await this.W.expireEntries(1 / 0));
    }
  }
  try {
  ...
  class z {
    constructor(t = {}) {
      ((this.K = t.statuses), (this.A = t.headers));
    }
    isResponseCacheable(t) {
      let e = !0;
      return (
        this.K && (e = this.K.includes(t.status)),
        this.A &&
          e &&
          (e = Object.keys(this.A).some(e => t.headers.get(e) === this.A[e])),
        e
      );
    }
  }
  class V extends v {
    constructor(t = {}) {
      (super(t), (this.U = t.networkTimeoutSeconds || 0));
    }
    async _(t, e) {
      let n, i;
      try {
        const s = [e.fetch(t)];
        if (this.U) {
          const t = R(1e3 * this.U);
          s.push(t);
        }
        if (((i = await Promise.race(s)), !i))
          throw new Error(
            `Timed out the network response after ${this.U} seconds.`
          );
      } catch (t) {
        t instanceof Error && (n = t);
      }
  ...
  class Z {
    constructor({ precacheController: t }) {
      ((this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
        const s =
          (null == e ? void 0 : e.cacheKey) || this.F.getCacheKeyForURL(t.url);
  ...
  class nt extends v {
    constructor(t = {}) {
      ((t.cacheName = d(t.cacheName)),
        super(t),
        (this.$ = !1 !== t.fallbackToNetwork),
        this.plugins.push(nt.copyRedirectedCacheableResponsesPlugin));
    }
    async _(t, e) {
        ...
        });
      {
        ...
        ((n = await e.fetch(
          ...
          s &&
            a &&
            "no-cors" !== t.mode &&
            (this.V(), await e.cachePut(t, n.clone())));
      }
      return n;
    }
    async G(t, e) {
    ...
    V() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== nt.copyRedirectedCacheableResponsesPlugin &&
          (n === nt.defaultPrecacheCacheabilityPlugin && (t = s),
          n.cacheWillUpdate && e++);
      0 === e
        ? this.plugins.push(nt.defaultPrecacheCacheabilityPlugin)
        : e > 1 && null !== t && this.plugins.splice(t, 1);
    }
  }
  ((nt.defaultPrecacheCacheabilityPlugin = {
    cacheWillUpdate: async ({ response: t }) =>
      !t || t.status >= 400 ? null : t,
  }),
    (nt.copyRedirectedCacheableResponsesPlugin = {
      cacheWillUpdate: async ({ response: t }) =>
        t.redirected ? await st(t) : t,
    }));
  class it {
    constructor({
      cacheName: t,
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        if ("string" != typeof n && n.integrity) {
          if (this.Y.has(t) && this.Y.get(t) !== n.integrity)
            throw new s("add-to-cache-list-conflicting-integrities", {
              url: i,
            });
          this.Y.set(t, n.integrity);
        }
        if ((this.J.set(i, t), this.X.set(i, r), e.length > 0)) {
  ...
  class ht {
    ...
    async addEntry(t) {
      const e = (await this.getDb()).transaction(ct, "readwrite", {
        durability: "relaxed",
      });
    ...
    async getFirstEntryId() {
      const t = await this.getDb(),
        e = await t.transaction(ct).store.openCursor();
      return null == e ? void 0 : e.value.id;
    }
    async getAllEntriesByQueueName(t) {
      const e = await this.getDb(),
        s = await e.getAllFromIndex(ct, ot, IDBKeyRange.only(t));
      return s || new Array();
    }
    async getEntryCountByQueueName(t) {
      return (await this.getDb()).countFromIndex(ct, ot, IDBKeyRange.only(t));
    }
    async deleteEntry(t) {
      const e = await this.getDb();
      await e.delete(ct, t);
    ...
    async getEndEntryFromIndex(t, e) {
      const s = await this.getDb(),
        n = await s.transaction(ct).store.index(ot).openCursor(t, e);
      return null == n ? void 0 : n.value;
    }
    async getDb() {
      return (
        this.k ||
          (this.k = await M("workbox-background-sync", 3, { upgrade: this.T })),
        this.k
      );
    }
    T(t, e) {
      e > 0 &&
        e < 3 &&
        t.objectStoreNames.contains(ct) &&
        t.deleteObjectStore(ct);
      t.createObjectStore(ct, { autoIncrement: !0, keyPath: "id" }).createIndex(
        ot,
        ot,
        { unique: !1 }
      );
  ...
  class ut {
    constructor(t) {
      ((this.tt = t), (this.et = new ht()));
    }
    async pushEntry(t) {
      (delete t.id, (t.queueName = this.tt), await this.et.addEntry(t));
    }
    async unshiftEntry(t) {
      const e = await this.et.getFirstEntryId();
      (e ? (t.id = e - 1) : delete t.id,
        (t.queueName = this.tt),
        await this.et.addEntry(t));
    }
    async popEntry() {
      return this.st(await this.et.getLastEntryByQueueName(this.tt));
    }
    async shiftEntry() {
      return this.st(await this.et.getFirstEntryByQueueName(this.tt));
    }
    async getAll() {
      return await this.et.getAllEntriesByQueueName(this.tt);
    }
    async size() {
      return await this.et.getEntryCountByQueueName(this.tt);
    }
    async deleteEntry(t) {
      await this.et.deleteEntry(t);
    }
    async st(t) {
  ...
  class ft {
    static async fromRequest(t) {
      ...
      for (const s of lt) void 0 !== t[s] && (e[s] = t[s]);
      return new ft(e);
    }
    constructor(t) {
      ("navigate" === t.mode && (t.mode = "same-origin"), (this.nt = t));
    }
    toObject() {
      const t = Object.assign({}, this.nt);
      return (
        (t.headers = Object.assign({}, this.nt.headers)),
        t.body && (t.body = t.body.slice(0)),
        t
      );
    }
    toRequest() {
      return new Request(this.nt.url, this.nt);
    }
    clone() {
      return new ft(this.toObject());
    }
  }
  const wt = "workbox-background-sync",
    dt = new Set(),
    yt = t => {
      const e = {
        request: new ft(t.requestData).toRequest(),
  ...
  class pt {
    constructor(
      t,
      { forceSyncFallback: e, onSync: n, maxRetentionTime: i } = {}
    ) {
      if (((this.it = !1), (this.rt = !1), dt.has(t)))
        throw new s("duplicate-queue-name", { name: t });
      (dt.add(t),
        (this.ct = t),
        (this.ot = n || this.replayRequests),
        (this.ht = i || 10080),
        (this.ut = Boolean(e)),
        (this.lt = new ut(this.ct)),
        this.ft());
    }
    get name() {
      return this.ct;
    ...
    async pushRequest(t) {
      await this.wt(t, "push");
    }
    async unshiftRequest(t) {
      await this.wt(t, "unshift");
    }
    async popRequest() {
      return this.dt("pop");
    }
    async shiftRequest() {
      return this.dt("shift");
    }
    async getAll() {
      const t = await this.lt.getAll(),
        e = Date.now(),
        s = [];
      for (const n of t) {
        const t = 60 * this.ht * 1e3;
        e - n.timestamp > t ? await this.lt.deleteEntry(n.id) : s.push(yt(n));
      }
      return s;
    }
    async size() {
      return await this.lt.size();
    }
    async wt({ request: t, metadata: e, timestamp: s = Date.now() }, n) {
      const i = {
        requestData: (await ft.fromRequest(t.clone())).toObject(),
        timestamp: s,
      };
      switch ((e && (i.metadata = e), n)) {
        case "push":
          await this.lt.pushEntry(i);
          break;
        case "unshift":
          await this.lt.unshiftEntry(i);
      }
      this.it ? (this.rt = !0) : await this.registerSync();
    }
    async dt(t) {
      const e = Date.now();
      let s;
      switch (t) {
        case "pop":
          s = await this.lt.popEntry();
          break;
        case "shift":
          s = await this.lt.shiftEntry();
      }
      if (s) {
        const n = 60 * this.ht * 1e3;
        return e - s.timestamp > n ? this.dt(t) : yt(s);
      }
    }
      ...
      for (; (t = await this.shiftRequest()); )
        try {
          ...
          throw (
            ...
            new s("queue-replay-failed", { name: this.ct })
          );
        }
    }
    async registerSync() {
      if ("sync" in self.registration && !this.ut)
        try {
          await self.registration.sync.register(`${wt}:${this.ct}`);
        } catch (t) {}
    }
    ft() {
      "sync" in self.registration && !this.ut
  ...
  class mt {
    constructor(t, e) {
      ((this.fetchDidFail = async ({ request: t }) => {
        await this.gt.pushRequest({ request: t });
      }),
        (this.gt = new pt(t, e)));
    }
  }
  ...
  const gt = "www.google-analytics.com",
    Rt = "www.googletagmanager.com",
    qt = /^\/(\w+\/)?collect/,
    bt = t => {
      const e = ({ url: t }) => t.hostname === gt && qt.test(t.pathname),
        s = new V({ plugins: [t] });
      return [new i(e, s, "GET"), new i(e, s, "POST")];
    },
    vt = t => {
      const e = new D({ cacheName: t });
      return new i(
        ({ url: t }) => t.hostname === gt && "/analytics.js" === t.pathname,
        e,
        "GET"
      );
    },
    Dt = t => {
      const e = new D({ cacheName: t });
      return new i(
        ({ url: t }) => t.hostname === Rt && "/gtag/js" === t.pathname,
        e,
        "GET"
      );
    },
    Et = t => {
      const e = new D({ cacheName: t });
      return new i(
        ({ url: t }) => t.hostname === Rt && "/gtm.js" === t.pathname,
        e,
        "GET"
      );
    };
  ((t.CacheFirst = class extends v {
    ...
    (t.CacheableResponsePlugin = class {
      constructor(t) {
        ((this.cacheWillUpdate = async ({ response: t }) =>
          this.Rt.isResponseCacheable(t) ? t : null),
          (this.Rt = new z(t)));
      }
    }),
    (t.ExpirationPlugin = class {
      ...
      bt(t) {
        if (t === y()) throw new s("expire-custom-caches-only");
        let e = this.Dt.get(t);
        return (e || ((e = new Q(t, this.vt)), this.Dt.set(t, e)), e);
      }
      qt(t) {
        if (!this.j) return !0;
        const e = this.Et(t);
        if (null === e) return !0;
        return e >= Date.now() - 1e3 * this.j;
      }
      Et(t) {
    ...
    (t.NavigationRoute = class extends i {
      constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
        (super(t => this.xt(t), t), (this._t = e), (this.Ut = s));
      }
      xt({ url: t, request: e }) {
        if (e && "navigate" !== e.mode) return !1;
        const s = t.pathname + t.search;
        for (const t of this.Ut) if (t.test(s)) return !1;
        return !!this._t.some(t => t.test(s));
      }
    }),
    (t.NetworkFirst = D),
    (t.NetworkOnly = V),
    ...
    (t.createHandlerBoundToURL = function (t) {
      return rt().createHandlerBoundToURL(t);
    }),
    (t.enable = function (t) {
      Boolean(self.registration && self.registration.navigationPreload) &&
    ...
    (t.initialize = (t = {}) => {
      const e = w(t.cacheName),
        s = new mt("workbox-google-analytics", {
      ...
      var n;
      const i = [Et(e), vt(e), Dt(e), ...bt(s)],
        r = new a();
      for (const t of i) r.registerRoute(t);
      r.addFetchListener();
    }),
