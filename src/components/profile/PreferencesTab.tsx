...
const PreferencesTab: React.FC = () => {
  const { userPreferences, updatePreferences, toggleWatchHistory, toggleNotifications } = useUserPreferences();
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <h3 className="text-lg font-medium text-white">Feature Notifications</h3>
            <p className="text-sm text-white/70">
