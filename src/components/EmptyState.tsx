                ...
                return {
                    ...
                    action: onClearFilters && (
                        <Button
                            ...
                            variant="outline"
                            className="mt-6 border-white/20 bg-white/5 hover:bg-white/10 hover:border-white/30 transition-all duration-300"
                            style={{
    ...
    return (
        <div className="relative flex min-h-[500px] flex-col items-center justify-center px-4 py-16 text-center">
            ...
            <div className="relative z-10">
                {/* Icon with gradient */}
                <div className="mb-6 inline-flex items-center justify-center rounded-full bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-sm border border-white/10 shadow-lg"
                    style={{
                        boxShadow: `0 0 40px ${accentColor}15, inset 0 0 20px ${accentColor}10`,
                    }}
                >
                    <div className="bg-gradient-to-br from-white/80 to-white/40 bg-clip-text text-transparent">
                        {content.icon}
                    </div>
                </div>
                ...
                <p className="mb-6 max-w-md text-base text-white/60 leading-relaxed">
                    {content.description}
                </p>
                ...
                {content.suggestions && content.suggestions.length > 0 && (
                    <div className="mb-6 flex flex-wrap justify-center gap-2">
                        {content.suggestions.map((suggestion, index) => (
                            <div
                                key={index}
                                className="rounded-full bg-white/5 px-4 py-2 text-sm text-white/50 border border-white/10 backdrop-blur-sm"
                            >
                                {suggestion}
                            </div>
                        ))}
